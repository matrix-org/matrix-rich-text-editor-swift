...
public struct FfiConverterTypeTextUpdate: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TextUpdate {
        ...
        case 2: return try .replaceAll(replacementHtml: FfiConverterSequenceUInt16.read(from: &buf), startUtf16Codeunit: FfiConverterUInt32.read(from: &buf), endUtf16Codeunit: FfiConverterUInt32.read(from: &buf))

        case 3: return try .select(startUtf16Codeunit: FfiConverterUInt32.read(from: &buf), endUtf16Codeunit: FfiConverterUInt32.read(from: &buf))
